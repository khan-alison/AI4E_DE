...
DROP TABLE IF EXISTS nnkhanh_schema.scd_type_1;
...
INSERT INTO nnkhanh_schema.scd_type_1 (cust_id, cust_nm, birth_date, add_id, opn_dt, end_dt, record_created_time)
SELECT cust_id, cust_nm, birth_date, add_id, opn_dt, end_dt, CURRENT_DATE
FROM ai4e_test.customer;
...
SELECT cust_id, cust_nm, birth_date, add_id, opn_dt, end_dt, '2023-10-19'
FROM ai4e_test.customer_cdc_19
ON CONFLICT (cust_id) DO UPDATE SET cust_nm             = EXCLUDED.cust_nm,
                                    birth_date          = EXCLUDED.birth_date,
                                    add_id              = EXCLUDED.add_id,
                                    opn_dt              = EXCLUDED.opn_dt,
                                    end_dt              = EXCLUDED.end_dt,
